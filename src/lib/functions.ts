...
export const invalidAlpha = (rule: Validator.Rule, value: any): boolean => {
  if (!rule || !rule.alpha) return false
  return !/^[a-zA-Z\s]+$/.test(value)
}

export const invalidAlphaNum = (rule: Validator.Rule, value: any): boolean => {
  if (!rule || !rule.alphaNum) return false
  return !/^[0-9a-zA-Z\s]+$/.test(value)
}

export const invalidAlphaDash = (rule: Validator.Rule, value: any): boolean => {
  if (!rule || !rule.alphaDash) return false
  return !/^[0-9a-zA-Z\s-_]+$/.test(value)
}

export const invalidEmail = (rule: Validator.Rule, value: any): boolean => {
...
export const invalidRequiredUnless = (rule: Validator.Rule, value: any, values: any): boolean => {
...
export const invalidRequiredWith = (rule: Validator.Rule, value: any, values: any): boolean => {
...
export const invalidRequiredWithout = (rule: Validator.Rule, value: any, values: any): boolean => {
...
export const invalidRequiredWithoutAll = (rule: Validator.Rule, value: any, values: any): boolean => {
...
export const errorMessage = (message: string | GenericObject | undefined, type: string, base: string,): string => {
